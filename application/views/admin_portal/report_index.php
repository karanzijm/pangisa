...
<div class="container-fluid report_page_root_division">
    <div class="row">
        ...
        <div class="col-sm-2 report_page_root_division_side_menu">
            <ul>
                <a href="<?=base_url()?>AppAdmin/Reports/General"><li><i class="fa fa-file-excel-o"></i> &nbsp; General </li></a>
                <a href="<?=base_url()?>AppAdmin/Reports/transactions"><li><i class="fa fa-file-excel-o"></i> &nbsp; Transactions </li></a>
                <a href="<?=base_url()?>AppAdmin/Reports/items"><li><i class="fa fa-file-excel-o"></i> &nbsp; Items </li></a>
                <a href="<?=base_url()?>AppAdmin/Reports/payments"><li><i class="fa fa-file-excel-o"></i> &nbsp; Payments </li></a>
                <a href="<?=base_url()?>AppAdmin/Reports/orders"><li><i class="fa fa-file-excel-o"></i> &nbsp; Orders </li></a>
                <a href="<?=base_url()?>AppClient/Reports/clients"><li><i class="fa fa-file-excel-o"></i> &nbsp; Client </li></a>
                <a href="<?=base_url()?>AppAdmin/Reports/vendors"><li><i class="fa fa-file-excel-o"></i> &nbsp; Vendors </li></a>
