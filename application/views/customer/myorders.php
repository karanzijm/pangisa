...
<div class="side_padding">
    ...
    $i=1;
        foreach ($data as $order):
            echo "
                <tr>
                    <td> <a href='".base_url()."Customer/Orders/view/".$order['id']."'>".$order['order_number']."</a></td>
                    <td> <a href='".base_url()."ICustomer/Orders/view/".$order['id']."'>".$order['name']."</a></td>
                    ...
                    <td>".$order['comment']."</td>
                    <td>".($order['approved']==0 && $order['user_cancel']!=1?"<a href='".base_url().'Customer/Orders/cancel/'.$order['id']."' alter='Cancel Order' ><i class='fa fa-trash-o'></i> </a>":null)." </td>
