...
<form method="POST" action="processPayment.php" id="paymentForm">
    ...
    <input type="hidden" name="email" value="fionotollan@yahoo.com"/>
    <!-- Replace the value with your customer email -->
    <input type="hidden" name="firstname" value="Olufemi"/>
    <!-- Replace the value with your customer firstname (optional) -->
    <input type="hidden" name="lastname" value="Olanipekun"/>
    ...
    <input type="hidden" name="successurl" value="http://request.lendlot.com/13b9gxc1?name=success">
    <!-- Put your success url here -->
    <input type="hidden" name="failureurl" value="http://request.lendlot.com/13b9gxc1?name=failed">
